...
async def get_supported_sources():
    """
    Возвращает список поддерживаемых источников новостей
    """
    return {
        "supported_sources": [
            {
                ...
                "description": "Новости экономики Украины",
                "supports_date_filter": True,
                "pagination_type": "date"
            },
            {
                "name": "Політека",
                "url": "https://politeka.net/uk/newsfeed",
                "description": "Политические новости Украины",
                "supports_date_filter": True,
            ...
            },
            {
                ...
                "description": "Главные новости Украины",
                "supports_date_filter": True,
                "pagination_type": "date"
            }
        ],
        "client_types": [
            {
                "name": "http",
                "description": "HTTP клиент (быстрее, рекомендуется по умолчанию)"
            },
            {
                "name": "browser",
                "description": "Браузерный клиент (медленнее, но для сложных сайтов с JavaScript)"
            }
        ]
    }
...
async def health_check():
    """
    Проверка работоспособности парсера новостей
    """
    return {
        "status": "healthy",
        "service": "news_parser",
